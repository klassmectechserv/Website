...
declare module '@unhead/schema' {
  ...
  type PublicFiles = '/_robots.txt' | '/android-chrome-192x192.png' | '/android-chrome-512x512.png' | '/apple-touch-icon.png' | '/favicon-16x16.png' | '/favicon-32x32.png' | '/favicon.ico' | '/site.webmanifest' | '/audio/ambient-tranquility-serene-soundscapes-365048.mp3' | (string & Record<never, never>)
